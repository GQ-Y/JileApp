...
import { deleteByIds, page } from '../../api/jileappCmsCategorie.ts'
...
defineOptions({ name: 'categorie:jileappCmsCategorie' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('cms.menu.categorie'),
    subTitle: () => t('cms.categorie.subTitle'),
  },
  // 表格参数
  tableOptions: {
    on: {
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['categorie:jileappCmsCategorie:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['categorie:jileappCmsCategorie:delete']"
          type="danger"
          plain
