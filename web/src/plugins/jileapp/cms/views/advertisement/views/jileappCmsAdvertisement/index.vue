...
import { deleteByIds, page } from '../../api/jileappCmsAdvertisement.ts'
...
defineOptions({ name: 'advertisement:jileappCmsAdvertisement' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('cms.menu.advertisement'),
    subTitle: () => t('cms.advertisement.subTitle'),
  },
  // 表格参数
  tableOptions: {
    on: {
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['advertisement:jileappCmsAdvertisement:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['advertisement:jileappCmsAdvertisement:delete']"
          type="danger"
          plain
