...
import { deleteByIds, page } from '../../api/jileappCmsTag.ts'
...
defineOptions({ name: 'tag:jileappCmsTag' })
...
const options = ref<MaProTableOptions>({
  ...
  header: {
    mainTitle: () => t('cms.menu.tag'),
    subTitle: () => t('cms.tag.subTitle'),
  },
  // 表格参数
  tableOptions: {
    on: {
  ...
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['tag:jileappCmsTag:delete']"
          type="danger"
          plain
